...
--		('Trigger_1', '2000.01.01', 'Trigger', 0),
--		('Trigger_3', '2000.01.01', 'Trigger', -1);
...
--		(9,2,'Властелин Колец: Две Крепости','Английский', '1945.10.09');
...
SELECT 
    ...
    Date_Of_Publishing
FROM Books
WHERE Date_Of_Publishing >= '2000-01-01'
WITH CHECK OPTION;
GO

INSERT INTO vw_Valid_Books (ID_Author, ID_Genre, Title, Native_Language, Date_Of_Publishing)
VALUES (1, 1, 'Пример книги', 'Русский', '2023-05-20');


INSERT INTO vw_Valid_Books (ID_Author, ID_Genre, Title, Native_Language, Date_Of_Publishing)
VALUES (1, 1, 'Будущая книга', 'Русский', '1999-12-31');
